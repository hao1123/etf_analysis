...
#海外ETF：       
        ...
        '159570.XSHE', # 华泰东南亚科技[ETF]-日均成交额：1.2亿-上市日期：2024-07（新增）
        '513160.XSHG', # 欧洲斯托克50[ETF]-日均成交额：1.2亿-上市日期：2024-06（新增）
    ]
    # 中国ETF池（含港股、指数、行业ETF）
    g.china_etf_pool = [
#港股ETF：
...
#行业ETF：
        ...
        '159647.XSHE', # (中药ETF鹏华) [ETF]-日均成交额：3.5亿元-上市日期：2022-07（新增）
        '159867.XSHE', # (畜牧ETF鹏华) [ETF]-日均成交额：1.8亿元-上市日期：2021-03（新增）
        '159745.XSHE', # (建材ETF国泰) [ETF]-日均成交额：1.2亿元-上市日期：2021-06（新增）
        '516530.XSHG', # (物流ETF银华) [ETF]-日均成交额：0.9亿元-上市日期：2021-06（新增）
    ]
...
def calculate_global_etf_threshold(context):
    ...
    try:
        ...
        threshold = avg_total_money / 15000
